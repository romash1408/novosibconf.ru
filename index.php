...
<div id='about' class='wrapper'>
	<div>
		...
		<p>В этом году мы уделим большое количестов времени для парктических рекомендаций по организации и улучшению тюремного служения.</p>
		<p>22 сентября состоится круглый стол с участием руководителей тюремного служения, представителей ФСИН, общественных и религиозных организаций.</p>
	</div>
</div>
	...
	<div>
		...
		<div>
			...
			<speaker>
				...
				<p>Председатель Попечительского Совета при УФСИН России по Тюменскому краю. Пастор.</p>
			</speaker>
			<speaker>
				<img src='/img/speakers/speaker03.jpg' alt='speaker03' />
				<h5>Каргапольцева Анна</h5>
				<p>Президент ПРООСПП "Выбор" Секретарь ОНК по Пермскому краю.</p>
			</speaker>
			<speaker>
		...
		<div class='clear'>
			...
			<speaker>
				<img src='/img/speakers/speaker06.jpg' alt='speaker06' />
				<h5>Желонкина Лариса</h5>
				<p>Старший юрист РЦХВЕ. Эксперт Гильдии экспертов при УФСИН России. Москва.</p>
			</speaker>
			<speaker>
...
<div id='registration' class='wrapper'>
	<div>
		<div><h2 id='registrationAnchor'>Регистрационный взнос</h2></div>
		...
		<div class='payment'><p>В регистрационный взнос входит оплата питания и кофе-брэйков. Взнос производится при регистрации участников конференции по месту проведения</p></div>
		<div class='clear'> </div>
